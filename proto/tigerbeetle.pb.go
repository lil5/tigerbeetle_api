...
type Account struct {
	...
	Ledger         int32         `protobuf:"varint,9,opt,name=ledger,proto3" json:"ledger,omitempty"`
...
func (x *Account) GetLedger() int32 {
	if x != nil {
		return x.Ledger
	}
	return 0
...
func (x *Transfer) GetLedger() int32 {
	if x != nil {
		return x.Ledger
	}
	return 0
...
var file_proto_tigerbeetle_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6c, 0x65, 0x64, 0x67, 0x65,
	...
	0x0a, 0x06, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06,
